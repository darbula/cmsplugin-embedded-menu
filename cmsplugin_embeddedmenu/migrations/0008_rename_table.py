...
class Migration(SchemaMigration):
  ...
  def backwards(self, orm):
    ...
    models = {
        ...
        u'cmsplugin_embeddedmenu.menupluginsettings': {
            'Meta': {'object_name': 'MenuPluginSettings', '_ormbases': ['cms.CMSPlugin']},
            u'cmsplugin_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['cms.CMSPlugin']", 'unique': 'True', 'primary_key': 'True'}),
            'depth': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'description': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'include_root': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
